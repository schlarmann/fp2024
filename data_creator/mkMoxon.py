...
def mkMoxon(spacing, horizontal = False):
    ...
    if horizontal:
        nf.writeFile("indata/moxon_"+str(spacing)+"_Horizontal.nec")
    else:
        nf.writeFile("indata/moxon_"+str(spacing)+"_Vertical.nec")
...
def mkMoxon45(length, horizontal = False):
    ...
    nf.addComment("Generated Moxon antenna")
    if horizontal:
        nf.writeFile("indata/moxon_"+str(length)+"_+45Deg.nec")
    else:
        nf.writeFile("indata/moxon_"+str(length)+"_-45Deg.nec")
